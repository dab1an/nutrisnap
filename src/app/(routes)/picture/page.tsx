...
export const CustomWebcam = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-10'>
      {imgSrc ? <img src={imgSrc} alt='your webcam image' /> : <video ref={videoRef} autoPlay muted className='rounded-lg'></video>}
      <p className='text-center w-4/5'>Make sure all food is in frame and take photo when ready</p>
      {!imgSrc ? (
